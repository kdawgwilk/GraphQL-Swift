public final class SchemaEnum<Enum: RawRepresentable>: SchemaType, AllowedAsObjectField, AllowedAsInputValue, AllowedAsNonNull, AnySchemaEnum where Enum.RawValue == String {
...
public struct SchemaEnumValue<Enum: RawRepresentable>: Identifiable, AnySchemaEnumValue where Enum.RawValue == String {
